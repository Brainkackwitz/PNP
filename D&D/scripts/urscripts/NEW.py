...
def role():
        ...
        try:
            ...
            pass
        classe1.config(text=str(classlist))
        #werte
...
rol1 = Button(menuf, text='open',width=5,command=open)
rol1.grid(row=0,column=7)
rol2 = Button(menuf, text='save',width=5,command=save)
rol2.grid(row=0,column=8)
#'''
